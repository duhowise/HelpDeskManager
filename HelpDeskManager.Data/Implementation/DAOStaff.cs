...
{
	public partial class DAOStaff : HelpDesk_BaseData
	{
		...
		///this method allows the object to delete itself from the table staff based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_DeleteOne;
			command.CommandType = CommandType.Text;
		...
		///This method returns all data rows in the table staff based on a foreign key
		///</Summary>
		///<returns>
		///IList-DAOStaff.
		///</returns>
		...
		///Int32? designationid
		///</parameters>
		public static IList<DAOStaff> SelectAllByDesignationid(Int32? designationid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_SelectAllByDesignationid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_SelectAllByDesignationidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method deletes all rows in the table staff with a given foreign key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_DeleteAllByDesignationid;
			command.CommandType = CommandType.Text;
		...
		///Int32? departmentid
		///</parameters>
		public static IList<DAOStaff> SelectAllByDepartmentid(Int32? departmentid)
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_SelectAllByDepartmentid;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_SelectAllByDepartmentidCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_DeleteAllByDepartmentid;
			command.CommandType = CommandType.Text;
			command.Connection = connectionProvider.Connection;
			command.Transaction = connectionProvider.CurrentTransaction;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table staff
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table staff based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprstaff_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
...
namespace HelpDeskManager.Data
{
	...
	{
		internal static string ctprstaff_SelectOne = @"
		...
		internal static string ctprstaff_DeleteOne = @"
		...
		internal static string ctprstaff_SelectAllByDesignationid = @"
		...
		internal static string ctprstaff_SelectAllByDesignationidCount = @"
		...
		internal static string ctprstaff_DeleteAllByDesignationid = @"
		...
		internal static string ctprstaff_SelectAllByDepartmentid = @"
			-- Select all rows based on a foreign key
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprstaff_SelectAllByDepartmentidCount = @"
			-- Get count of rows returnable by this query
			-- selects count of all rows from the table
			SELECT COUNT(*)
			FROM [dbo].[staff]
		...
		internal static string ctprstaff_DeleteAllByDepartmentid = @"
		...
		internal static string ctprstaff_InsertOne = @"
			-- Insert a new row
		...
		internal static string ctprstaff_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprstaff_SelectAllCount = @"
		...
		internal static string ctprstaff_SelectAllBySearchFields = @"
		...
		internal static string ctprstaff_SelectAllBySearchFieldsCount = @"
			-- Get count of rows returnable by this query
		...
		internal static string ctprstaff_UpdateOne = @"
