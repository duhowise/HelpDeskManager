...
{
	public partial class DAODesignation : HelpDesk_BaseData
	{
		...
		///this method allows the object to delete itself from the table designation based on its primary key
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprdesignation_DeleteOne;
			command.CommandType = CommandType.Text;
		...
		///<Summary>
		///Insert a new row
		///This method saves a new object to the table designation
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprdesignation_InsertOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprdesignation_SelectAllCount;
			command.CommandType = CommandType.Text;
			SqlConnection staticConnection = StaticSqlConnection;
			command.Connection = staticConnection;
		...
		///This method allows the object to update itself in the table designation based on its primary key(s)
		///</Summary>
		///<returns>
		///void
		///</returns>
		...
		{
			SqlCommand	command = new SqlCommand();
			command.CommandText = InlineProcs.ctprdesignation_UpdateOne;
			command.CommandType = CommandType.Text;
			command.Connection = _connectionProvider.Connection;
			command.Transaction = _connectionProvider.CurrentTransaction;
...
namespace HelpDeskManager.Data
{
	...
	{
		internal static string ctprdesignation_SelectOne = @"
		...
		internal static string ctprdesignation_DeleteOne = @"
			-- Delete a row based on the primary key(s)
			-- delete all matching from the table
			DELETE [dbo].[designation]
			WHERE 
			[id] = @id
			";

		internal static string ctprdesignation_InsertOne = @"
			-- Insert a new row
		...
		internal static string ctprdesignation_SelectAll = @"
			-- Select All rows
			-- selects all rows from the table
			SELECT 
			[id]
		...
		internal static string ctprdesignation_SelectAllCount = @"
		...
		internal static string ctprdesignation_SelectAllBySearchFields = @"
		...
		internal static string ctprdesignation_SelectAllBySearchFieldsCount = @"
		...
		internal static string ctprdesignation_UpdateOne = @"
